...
class ProdutoCreate(BaseModel):
    ...
    codigo_barras: str  # Campo para código de barras
...
class ProdutoUpdate(BaseModel):
    ...
    codigo_barras: Optional[str] = None  # Campo opcional para código de barras
...
class Produto(ProdutoCreate):
    ...
    class Config:
        orm_mode = True  # Correção para Pydantic V2
